    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <div class="accordion" id="accordionTerms">
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#privacidad">
                            2. Políticas de Privacidad
                        </button>
                    </h2>
                    <div id="privacidad" class="accordion-collapse collapse">
                        <div class="accordion-body">
                            Sus datos personales son tratados con absoluta confidencialidad de acuerdo a la Ley N° 25.326 de Protección de Datos Personales de Argentina. Solo recopilamos información necesaria para el procesamiento de envíos y facturación.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#ventas">
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#envios">
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#garantia">
                            5. Garantía y Soporte Postventa
                        </button>
                    </h2>
                    <div id="garantia" class="accordion-collapse collapse">
                        <div class="accordion-body">
                            Todos nuestros productos cuentan con garantía oficial de fábrica por fallas de manufactura (mínimo 6 meses según ley). El soporte postventa está disponible vía WhatsApp o correo electrónico para cualquier duda sobre el uso del equipo adquirido.
                        </div>
                    </div>
                </div>

            </div> <div class="mt-5 p-4 bg-light border rounded">
                <p class="small mb-0">Para consultas adicionales, puede visitarnos en nuestro local en Corrientes Capital o contactarnos a través de nuestra sección de contacto.</p>
            </div>
        </div>
    </div>
</div>
